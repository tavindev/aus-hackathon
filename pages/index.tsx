        ...
        <>
            ...
            <main className="flex flex-col items-center w-screen min-h-screen overflow-x-hidden">
                            ...
                            <div className="flex flex-grow justify-between items-center   overflow-hidden">
                                <div>
                                    ...
                                    <p className="flex-wrap text-xl">
                                        O novo Assistente Universal de Saúde
                                        integrado com o SUS
                                    </p>
                                </div>
                ...
                <section className="container cards-section w-full box-border">
                    <div className="cards-section-grid grid grid-rows-3 grid-cols-2 2xl:grid-rows-2 2xl:grid-cols-3 gap-5 justify-center items-center w-full h-full box-border py-10 2xl:py-5">
                        <MiniCard
                            title="SUSana"
                            description="Está se sentindo mal? Faça uma breve consulta com a nossa Assistente Virtual"
                        />
                        <MiniCard
                ...
                <section
                    ref={aboutRef}
                    className="about flex justify-center items-center w-screen py-6"
                >
                    <div className="container flex justify-center items-center h-full">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-start mt-11 flex-wrap">
                                O Assistente Universal de Saúde é um aplicativo
                                do governo que integrará os dados sanitários de
                                todos os habitantes de Technópolis para
                                dinamizar o acompanhamento, o tratamento e a
                                prevenção de doenças. Por meio de sua interface
                                interativa e integração com o Sistema Único de
                                Saúde, o AUS centralizará todas as informações
                                clínicas de pacientes do país inteiro,
                                facilitando o monitorameto da saúde de cada um e
                                o compartilhamento de informações essenciais em
                                casos de emergência médica. Além de atuar como
                                forma de dinamização e universalização dos
                                sistemas públicos de saúde, o AUS será um grande
                                agente de educação e conscientização, colocando
                                o usuário no centro do processo medicinal a
                                partir da plataforma de Saúde Interativa e das
                                informações personalizadas sobre Medicina
